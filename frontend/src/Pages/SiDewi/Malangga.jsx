        ...
        <div className="relative z-10 w-full h-full p-20">
          <div className="md:w-2/3 max-w-2xl">
            <p className="text-lg leading-relaxed">
              Malangga terkenal dengan keindahan bentang alam dan budaya
              tradisionalnya. Wisatawan dapat merasakan perpaduan pesona hutan
              tropis, aliran sungai jernih, serta keramahan penduduk lokal yang
              menjadikan perjalanan penuh cerita dan pengalaman autentik.
            </p>
          </div>
