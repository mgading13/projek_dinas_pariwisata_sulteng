...
import Towale1 from "../../assets/SiDewi/Towale1.jpg";
import Towale2 from "../../assets/SiDewi/Towale2.jpg";
import Towale3 from "../../assets/SiDewi/Towale3.jpg";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${Towale1})` }}
      >
        ...
        <div className="relative z-10 w-full h-full p-20">
          ...
          <div className="md:w-1/4 flex flex-col justify-center mt-10 md:mt-0 md:ml-auto space-y-3">
            <Card className="bg-white/0 border-0 border-b-2 border-white text-white">
              ...
              <CardContent>
                <p className="text-gray-300">50 km dari Palu ➜ Towale</p>
              </CardContent>
            </Card>
            <Card className="bg-white/0 border-0 border-b-2 border-white text-white">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-300">Palu ➜ Donggala ➜ Towale</p>
              </CardContent>
            </Card>
            <Card className="bg-white/0 border-0 border-b-2 border-white text-white">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-300">Bandara Palu ➜ Towale</p>
              </CardContent>
            </Card>
          </div>
        </div>
